...
%
% Example:
%     btime = string(datetime('now'));
%     cprintf([153 51 255],'------ The Begin time is: \n');
%     cprintf([153 51 255],'       ')
%     cprintf([153 51 255],btime);
%     cprintf([153 51 255],'\n')
%
%     cprintf([255 0 102],'------ LaterBlock Calculate have Finished!\n')
%     etime = datetime('now');
%     cprintf([0 102 255],'------ The Cost time is: \n');
%     ct = string(etime - btime);
%     cprintf([1 0 1],'------ ')
%     cprintf([1 0 1],ct);
%     cprintf([1 0 1],'\n')
%
